...
internal abstract class FunctionCall {
   ...
   functionCall(expressionFunction: ExpressionFunction): protected {
     ExpressionFunction = expressionFunction ?? throw new Error(nameof(expressionFunction));
   }

   public static create(expression: FunctionCallExpression): FunctionCall {
   ...
   public abstract customMethodSyntax(context: ICompileFunctionContext): MemberDeclarationSyntax;

   public abstract callExpressionSyntax(context: ICompileFunctionContext): ExpressionSyntax;
}
