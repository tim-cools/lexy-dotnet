...
namespace Lexy.Poc.Core.Language.Expressions
{
    public class FunctionCallExpression : Expression
    {
        ...
        private FunctionCallExpression(string functionName, Expression expression, Line sourceLine, TokenList tokens) : base(sourceLine, tokens)
        {
        ...
        public static ParseExpressionResult Parse(Line sourceLine, TokenList tokens)
        {
            ...
            var expression = new FunctionCallExpression(functionName, innerExpression, sourceLine, tokens);
