...
namespace Lexy.Poc.Core.Language.Expressions
{
    public class FunctionCallExpression : Expression
    {
        ...
        private FunctionCallExpression(string functionName, Expression expression, ExpressionSource source) : base(source)
        {
        ...
        public static ParseExpressionResult Parse(ExpressionSource source)
        {
            ...
            var expression = new FunctionCallExpression(functionName, innerExpression, source);
