...
namespace Lexy.Poc.Core.Language
{
    ...
    {
        public static void Validate<T>(IValidationContext context, Func<T, SourceReference> getReference, Func<T, string> getName, Func<T, string> getErrorMessage, params IList<T>[] lists)
        {
