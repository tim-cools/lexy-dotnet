...
namespace Lexy.Compiler.Language.Types
{
    ...
    {
        public static void ValidateTypeAndDefault(this IValidationContext context, SourceReference reference, VariableDeclarationType type, Expression defaultValueExpression)
        {
